...
sudo docker build /go-trivia/staging/frontend/. -t mraagil/trivia-frontend:staging
sudo docker build /go-trivia/staging/backend/. -t mraagil/trivia-backend:staging
