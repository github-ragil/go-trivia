...
su ubuntu -c 'cd /go-trivia/prod && make install namespace=prod frontendhpa=true backendhpa=true && make upgrade namespace=prod frontendhpa=true backendhpa=true'